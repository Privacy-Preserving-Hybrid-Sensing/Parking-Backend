...
from .views import profile_creditbalance, profile_participation_days_ago, profile_register_email
...
urlpatterns = [
    ...
    path("profile/participation/<int:days_ago>", profile_participation_days_ago, name="profile_participation_days_ago"),
