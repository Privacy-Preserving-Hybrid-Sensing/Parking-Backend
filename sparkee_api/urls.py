...
urlpatterns = [
    ...
    re_path(r"^subscribe/parking_availability/near/(?P<radius>[0-9\.]+)/(?P<longitude>[0-9\.\+\-]+)/(?P<lattitude>[0-9\.\+\-]+)/(?P<participant_uuid>[0-9a-f\-]+)$", subscribe_parking_availability, name="subscribe_parking_availability"),
